(function() {
    function SmackTalk($firebaseArray, Fixtures) {
        ...
        */
        ...
        SmackTalk.getInsertable = function(string, roomId) {
            currentInsertable = Fixtures.getInsertable(string);
    ...
    angular
        ...
        .service('SmackTalk', ['$firebaseArray', 'Fixtures', SmackTalk]);
})();