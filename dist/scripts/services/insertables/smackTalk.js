...
//        }
        ...
        SmackTalk.retrieve = function(gender, exclusions) {
            ...
            stringIndex = allInsertables.indexOf(string);
            return {
                    string:string,
                    index: stringIndex
                   }
        ...
        SmackTalk.retrieveTest = function() {
            return  allInsertables[Math.floor(Math.random() * allInsertables.length)];
        }
